      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
          { property.rates.nightly && (
            <p><FaMoneyBill className="inline mr-0.5 mb-0.5" /> Nightly</p>
          ) }
          { property.rates.weekly && (
            <p><FaMoneyBill className="inline mr-0.5 mb-0.5" /> Weekly</p>
          ) }
          { property.rates.monthly && (
            <p><FaMoneyBill className="inline mr-0.5 mb-0.5" /> Monthly</p>
          ) }
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          <div className="flex align-middle gap-2 mb-4 lg:mb-0">
            <FaMapMarker className="inline text-lg text-orange-700 mt-1"/>
